  ...
  return (
    <section className=" mt-0 md:mt-10 mx-0 md:mx-24 md:mb-10 md:min-h-screen bg-cover grid md:grid-rows-3 " >
      ...
      <div className="col-span-12 px-4 ">
        <div className=" bg-white rounded-xl shadow-sm overflow-hidden mt-5 col-span-12 border-green-700 border hidden sm:block">
        ...
        <p className="md:mb-5 text-lg md:text-base">
          <span><b>
