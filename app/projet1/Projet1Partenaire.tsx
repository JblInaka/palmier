...
const Projet1Partenaire = () => {
  ...
  return (
    <section className="mt-10 pt-9 mx-3 md:mx-24 grid grid-cols-12 md:min-h-screen bg-cover rounded-3xl" style={{backgroundImage: "url('./BAD.png')", backgroundSize: "100% 100%"}}>
      <h2 className="row-1 col-span-12 text-4xl md:text-5xl text-justify font-bold mb-8 text-black" style={{ fontFamily: "'Swanky and Moo Moo', cursive" }}    >
        Partenaires locaux
      </h2>
