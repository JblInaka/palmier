...
import DropdownPays from "@/components/DropdownPays";
import ProjectsTous from "../projects_by_date/ProjectsTous";
...
const ProjetListe = () => {
  ...
  if (getSelectedValue === "congo") {
    ...
    projetToShow = <ProjectsTous />;
  }

  return (
    <>
    <div className="hidden sm:block">
      <div className="mx-0 md:mx-24 grid grid-cols-12 ">
        <div className="col-start-1 md:col-start-1">
          <DropdownPays onSelectChange={getSelectedValueFromChild} />
        </div>
        <div className="col-start-3 md:col-start-4">
          <DropdownDate onSelectChange={getSelectedValueFromChild} />
        </div>
      </div>
    </div>
      {projetToShow}
