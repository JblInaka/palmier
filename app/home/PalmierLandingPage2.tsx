...
<div className="px-4 md:px-6 mt-6 bg-[#EDEDCB]/70 border border-transparent ring ring-blur ring-white">
  <div className="px-1 py-1 bg-white mt-4 mx-auto rounded-full border-[6px] w-full md:w-[994px] h-auto md:h-[75px] border-[#B9DEC3]">
    <div className="px-5 py-2 md:py-0.5 rounded-full bg-[#B9DEC3] w-full h-full">
      <p className="text-sm md:text-base">Soutenons des projets innovants en Afrique, améliorons les conditions de vie des populations locales.</p>
    </div>
  </div>
  <div className="px-1 py-1 bg-white mt-3 mx-auto rounded-full border-[6px] w-full md:w-[994px] h-auto md:h-[75px] border-[#B9DEC3]">
    <div className="px-5 py-2 md:py-0.5 rounded-full bg-[#B9DEC3] w-full h-full">
      <p className="text-sm md:text-base">Façonnons l’avenir et inspirons le changement positif pour un impact durable en Afrique.</p>
    </div>
  </div>
  <div className="px-1 py-1 bg-white mt-3 mx-auto mb-8 rounded-full border-[6px] w-full md:w-[994px] h-auto md:h-[75px] border-[#B9DEC3]">
    <div className="px-5 py-2 md:py-0.5 rounded-full bg-[#B9DEC3] w-full h-full">
      <p className="text-sm md:text-base">Promouvons la transparence tout en favorisant des partenariats solides et inclusifs.</p>
    </div>
  </div>
</div>
